...
class ModelPredictiveControl(object):
    ...
    def _parse_naren_control(self, world):
        ...
        if goal:
            ...
            LANE_CHANGE_TIMING = 45
            LANE_CHANGE_TIMING_END = 53
            TAEGET_V = 40
            MAX_V = 60
            SAFE_DISTANCE = 45
            ...
            #SCENARIO_NUM = 3
            SCENARIO_NUM = 1
            if SCENARIO_NUM == 4 or SCENARIO_NUM == 3:
...
def game_loop(args):
    ...
    try:
        ...
        controller = ModelPredictiveControl(world, [lc_x, lc_y, lc_yaw], args.autopilot)
